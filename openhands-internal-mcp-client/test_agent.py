"""Test script for the OpenHands Agent.

This demonstrates how to use the OpenHands agent to solve coding tasks.
"""
...
from openhands_agent import run_agent, AgentConfig
...
async def main() -> None:
    """Run a test task with the OpenHands agent."""
